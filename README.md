<p align="center"><img src="https://github.com/U7P4L-IN/PhoneSploit-X/blob/master/image/github-header-image.png">
 
### PhoneSploit with Metasploit Integration.
<p>
 <img src="https://img.shields.io/github/stars/U7P4L-IN/PhoneSploit-X?color=%23DF0067&style=for-the-badge"/> &nbsp;
 <img src="https://img.shields.io/github/forks/U7P4L-IN/PhoneSploit-X?color=%239999FF&style=for-the-badge"/> &nbsp;
 <img src="https://img.shields.io/github/license/U7P4L-IN/PhoneSploit-X?color=%23E8E8E8&style=for-the-badge"/> &nbsp;
...
Make sure all the [required](https://github.com/U7P4L-IN/PhoneSploit-X#requirements) software are installed.

Open terminal and paste the following commands : 
```
git clone https://github.com/U7P4L-IN/PhoneSploit-X.git
```
```
cd PhoneSploit-X/
```
```
python3 PhoneSploit-X.py
```
#### On Windows :
...
```
python PhoneSploit-X.py
```


# Screenshots

<p align="center"><img src="https://github.com/U7P4L-IN/PhoneSploit-X/blob/master/image/ScreenShot_20230809201211.png">
<p align="center"><img src="https://github.com/U7P4L-IN/PhoneSploit-X/blob/master/image/ScreenShot_20230809201340.png">
<p align="center"><img src="https://github.com/U7P4L-IN/PhoneSploit-X/blob/master/image/ScreenShot_20230809200956.png">
...
<!--   <img src="https://contrib.rocks/image?repo=U7P4L-IN/PhoneSploit-X" /> -->
 <img width="150px" src=https://github.com/U7P4L-IN/PhoneSploit-X/blob/master/image/ScreenShot_20230809201211.png/>

</a>


**U7P4L 1N** - [@U7P4L-IN](https://github.com/U7P4L-IN/)
